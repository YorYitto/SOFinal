...
public class Acciones{
    ...
    Acciones(String filename){

        if (filename.equals("FIFO")){
          System.out.println( "Ejecutando programa con opcion FIFO..." );
          algorithm = this.FIFO;

          
        }else if(filename.equals("Round Robin")){
          System.out.println( "Ejecutando programa con opcion Round Robin..." );
   ...
   // lee datos ingresados del textArea y los agrega como procesos
    void agrega_proceso(String grosso){
	    ...
	    String nom = null;
	     ...
	     int num_procesos = Integer.parseInt(st.nextToken());
